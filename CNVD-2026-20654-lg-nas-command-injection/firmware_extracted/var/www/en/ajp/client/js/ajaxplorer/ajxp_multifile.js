...
function MultiSelector( formObject, list_target, max ){
	...
	this.setOnLoad = function()	{
		...
		//by soo. 
		//var parentObject = $('dialogContent');
		var parentObject = $('generic_dialog_box');;
	...
	this.removeOnLoad = function(){
		//by soo. 
		removeLightboxFromElement($('generic_dialog_box'));
		//var parentObject = document.getElementsByTagName('form');
