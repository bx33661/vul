...
"29" => "Create",
"30" => "Write a name of directory then click on &quot;Create&quot;",
"31" => "You must select a file",
"32" => "Explore",
"33" => "Error uploading file !",
"34" => "The file",
"35" => "has been successfully created",
"36" => "It's size is",
...
"72" => "The root path is not correct.",
...
"177" => "Are you sure you want to delete the selected files?",
"178" => "Previous",
"179" => "Next", 
...
"500" => "Successfully logged out",
"501" => "Invalid characters",
"502" => "The total file count limit has been reached.",
"503" => "There is no space in the destination volume.",
"504" => "The destination folder is a subfolder of the source.",
"505" => "The file is in use.",
"506" => "Error",
"507" => "Estimated time left :",
"508" => "Transfer rate :",
"509" => "This session has expired for security reasons. Please log in again.",
"510" => "Optional",
"511" => "Link has expired.",
"512" => "(Maximum File Upload Size is 2GB)",
"513" => "Check file size!!",
"514" => "File input/output error. \\n1)Check selected file.(size,permission...)\\n2)Check available disk size.",
"515" => "Self Read/Write only",
"516" => "Others can read only",
"517" => "Others can read and write",
"518" => "You are not permitted reading this file/folder",
"519" => "Permission changed on this file/folder",
"520" => "Check the file permission!(Public link requires a read permission for others)",
"521" => "Special characters in passwords are not allowed.",
);
?>
