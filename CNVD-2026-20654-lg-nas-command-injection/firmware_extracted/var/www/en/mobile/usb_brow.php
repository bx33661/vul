...
<script language="javascript1.2" src="../js/usb_brow.js.php" ></script>
<!----------------------------------->
	...
	<tr>
		...
		<td width="100%" style="padding:0 0 0 50px">
			...
			<tr>
				...
				<img src="../images/headtitle/htit_usb_memory.gif" />
	...
	<!-- File Box End -->
                  ...
                  <!-- 중앙 화살표 시작-->
                    ...
                    <table width="32" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td>
                          <a href="javascript:void(0)" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('arrow1','','../images/btn/btn_burn_02_on.gif',1)"><img onclick='copy_nas_to_esata();' src="../images/btn/btn_burn_02.gif" name="arrow1" width="32" height="32" border="0" id="arrow1" TITLE="<?php echo lang_get('usb_2')?>"/></a>
                          </td>
                        </tr>
                          ...
                          <table width="300" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
									...
									<td width="8">&nbsp;</td>
									<td width="32">
										<a href="javascript:void(0)" onclick="usb.get_dev_list();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('burning_tab_14','','../images/btn/btn_burn_04_on.gif',1)"><img src="../images/btn/btn_burn_04.gif" name="burning_tab_14" width="32" height="32" border="0" id="burning_tab_14" TITLE="<?php echo lang_get('burning_msg_33')?>"/></a>
									...
									<td width="8px">&nbsp;</td>
									<td width='180px' valign='middle' align='right'>									
											<!--<div id="id_usb_dev" ></div>-->
                                      ...
                                      <td height="18" align="center" background="../images/input_bg_c.gif"><table width="290" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td height="20" class="gray" >
                                            	<!--<div id="idPathEsata" width="100" style="display:block;"><?php echo lang_get('usb_msg_8_1')?></div>-->	<!-- e-SATA list to select -->
                                            	<div id="idPathEsata" width="100" style="display:block;"> </div>	<!-- e-SATA list to select -->
                                            </td>
                                            <!--<td width="20" align="center"><img src="../images/input_arrow.gif" width="13" height="12" /></td>-->
                                          </tr>
                                      </table></td>
		...
		<td align="center" background="../images/Burn/b_bg.gif">
			...
			<table width="600" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="100" align="center" id="id_td_dev"><?php echo lang_get('usb_4')?></td>
				</tr>
...
<td align="right" style="padding:20 0 0 0px">
	<div id='idButtonBurnNext' style='visibility:visible;'>
		<!--<a href="javascript:void(0)" onclick="esata.connect('conn');"><img src="../images/btn/btn_connect.gif" width="75" height="22" border="0" /></a>-->
	</div>
</td>
</tr>
<!--Next button : end-->  
