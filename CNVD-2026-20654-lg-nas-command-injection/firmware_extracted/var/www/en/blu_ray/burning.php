...
<script type='text/javascript' src="../js/burning.js.php" charset="utf-8"></script>
<!----------------------------------->


<?php

$iscsicheck = exec("sudo nas-service get enabled iscsi");
$backupcheck = exec("sudo nas-service get running odd_backup");

if($iscsicheck == 'off' && $backupcheck == 'off')
	$res = "off";
else
	$res = "on";
...
<td width="100%" valign="top"><!-- 사이즈 수정 -->
	...
	<tr>
		...
		<td width="100%" style="padding:0 0 0 50px">
			...
			<tr>
				<td height="50" valign="top"><img src="../images/headtitle/htit_burning.gif"/></td>
			</tr>
			<tr>
				<td height="30">
                              ...
                              <tr>
                                ...
                                <table width="300" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      ...
                                      <td width="200px">
                                      <input type="text" name="idBurnVolume" maxlength="32" size="30" class="inputtext" id="idBurnVolume" onblur="FormCheck_discname('idBurnVolume');" value="LG_NAS"/>
                                      </td>
                                    </tr>
                                </table>
                                </td>
                                    ...
                                    <tr>
                                      <td height="18" align="center" background="../images/input_bg_c.gif"><table width="290" border="0" cellspacing="0" cellpadding="0">
                                          <tr>                                          
                                            ...
                                            <?php  if ($res == "off") { ?>
                                            <div id="idBurnTitle">
                                            <?php echo lang_get('burning_msg_1')?>
						  <? } ?>
						  <?php  if ($res == "on") { ?> 
            ...
            <td height="70" valign="top"><table width="650" height="46" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <table width="600" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="50"><?php echo lang_get('volume_3')?><!--<img src="../images/txt/b_txt_01.gif" width="100" height="18" />--></td>
                        <td width="20"></td>
                        <td>
                        <input id="idBurnSize" type="text" name="textfield2" size="70" class="inputtext" value="0 Byte / 0 Byte" disabled/>
                        </td>
                        <td width="20"></td>
                        <!--Refresh button-->
                        <td width="72">
                        		<!--<a href="javascript:void(0)" onclick="burn_data();"><img src="../images/Burn/b_bt.gif" width="72" height="22" border="0" /></a>-->
                        		<?php if ($res != "on") { ?>
                        		<div id='id_btn_refr_data' style='visibility:visible;'><img src="../images/btn/btn_refresh.gif" border="0" onclick="burning.load_disc('data burn');" style="cursor:pointer;"/>
					<? } ?>
                        		</div>
                        </td>
                        <!--Refresh button : end-->
		...
		<table>
			<tr>
				...
				<td width="270px" align="right">
						...
						<input id="id_btn_burn_data" type="image" onclick="burning.odd_busy_chk();" src="../images/btn/btn_burn.gif" border="0" />
					</td>
				</tr>
		</table>
</td>
...
if(warnMsg.match("<?php echo lang_get('iscsi_3')?>"))
	alert("<?php echo lang_get('iscsi_3') ?>");
else if(warnMsg.match("<?php echo lang_get('storing_backup_warn')?>"))
	alert("<?php echo lang_get('storing_backup_warn') ?>");
else
	page.init();
</script>
