<?php
    $auth_actions["login"]["callback"] = 'switchAction';
    $auth_actions["login"]["rights"] = array("NOUSER" => "false", "USERLOGGED" => "hidden", "GUESTLOGGED" => "show", "READ" => "false", "WRITE" => "false", "ADMINONLY" => "");
    $auth_actions["login"]["XML"] = '<action name="login">
    ...
    $auth_actions["logout"]["callback"] = 'switchAction';
    $auth_actions["logout"]["rights"] = array("NOUSER" => "false", "USERLOGGED" => "only", "GUESTLOGGED" => "hidden", "READ" => "false", "WRITE" => "false", "ADMINONLY" => "");
    $auth_actions["logout"]["XML"] = '<action name="logout">
