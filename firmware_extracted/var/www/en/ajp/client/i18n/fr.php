...
"72" => "La racine du répertoire est incorrecte.",
...
"500" => "Déconnecté avec succès",
"501" => "Caractères invalide",
"502" => "La limite totale nombre de fichiers a été atteinte.",
"503" => "Il n'y a plus d'espace dans le volume designé",
"504" => "Dossier de destination est un sous-dossier de la source.",
"505" => "Le fichier est en cours d'utilisation",
"506" => "Erreur",
"507" => "Temps restant:",
"508" => "Taux de transfert:",
"509" => "Cette session a été expirée pour des raisons de securité. Veuillez-vous loger de nouveau.",
"510" => "Option",
"511" => "La connexion est expirée, desolée",
"512" => "(Taille maximale des fichiers est de 2 Go Upload)",
"513" => "Vérifiez taille!!",
"514" => "Erreur E/S. \\n1)Vérifiez le fichier sélectionné.(taille,permission...)\\n2)Vérifier la taille du disque disponible.",
"515" => "Auto en lecture/écriture que",
"516" => "D'autres ne peut lire que",
"517" => "D'autres peuvent lire et écrire",
"518" => "Vous n'êtes pas autorisé la lecture de ce fichier/dossier",
"519" => "Permission modification de ce fichier/dossier",
"520" => "Vérifiez les permissions des fichiers!(lien public requiert une autorisation de lecture pour les autres)",
"521" => "Les caractères spéciaux dans les mots de passe ne sont pas autorisés.",
);
?>
