<?php
	include_once "../../../en/session/session_info.php";
	function invalid_access_error_msg_return()
	{
	        ...
	        echo "alert('This session was expired due to security reasons. Please log in again.');\n";
	...
	sm_session_check('admin','/index.php');
?>
...
<html>
	<head>
		...
		<!--[if IE 8]><link media="screen" href="./stylesheets/ie8.css" type="text/css" rel="stylesheet" /><![endif]-->
	...
	<body id="transmission_body">
		...
		<div class="dialog_container" id="dialog_container" style="display:none;">
			...
			<div class="dialog_window">
				<img src="images/graphics/new_logo.jpg" alt="Transmission Logo" />
