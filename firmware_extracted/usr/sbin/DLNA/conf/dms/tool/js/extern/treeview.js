...
YAHOO.widget.TreeView.prototype = {
    ...
    setLabelClickHandler: function(fnLabelClickHandler) { 
        this.root.setLabelClickHandler(fnLabelClickHandler);
    },
...
YAHOO.widget.TreeView.preload = function(prefix) {
    prefix = prefix || "ygtv";
    var styles = ["tn","tm","tmh","tp","tph","ln","lm","lmh","lp","lph","loading","lnw","tnw"];
    ...
    */
    ...
    getStyle: function() {
        if (this.isLoading) {
            ...
            var type = "n";
            if ((this.hasChildren(true) && this.data['togglable']) 
             || (this.isDynamic() && !this.getIconMode())) {
            // if (this.hasChildren(true)) {
                type = (this.expanded) ? "m" : "p";
            }
            var toggle_type = (this.data['togglable']) ? "": "w";

            return "ygtv" + loc + type + toggle_type;
        }
    },
    ...
    getHoverStyle: function() { 
        var s = this.getStyle();
        if (this.hasChildren(true) && !this.isLoading && this.data['togglable']) { 
            s += "h"; 
        }
        return s;
    },
    ...
    setLabelClickHandler: function(fnLabelClickHandler) { 
        if (fnLabelClickHandler) {
            this._labelClickHandler = fnLabelClickHandler;
        }
    },
...
//        sb[sb.length] = ' href="' + 'javascript:YAHOO.widget.TreeView.dummy()' +  '"';
        sb[sb.length] = ' href="' + 'javascript:' + getNode + '.onLabelClick(' + getNode +')"';
...
//        sb[sb.length] = ' onclick="return ' + getNode + '.onLabelClick(' + getNode +')"';
        ...
        if (this.hasChildren(true)) {
            ...
            sb[sb.length] = getNode + '.getHoverStyle(); window.status=\'\'; return true"';
            sb[sb.length] = ' onmouseout="document.getElementById(\'';
            sb[sb.length] = this.getToggleElId() + '\').className=';
            sb[sb.length] = getNode + '.getStyle()"';
        } else {
            sb[sb.length] = ' onmouseover="window.status=\'\'; return true"';
        }
        sb[sb.length] = ' >';
    }
...
YAHOO.widget.TextNode.prototype.onLabelClick = function(me) { 
    if (!this.locked) {
        // XXX: dirty
        mstweb_page_backup.on_label_click(me);
    } 

/*
    if (this._labelClickHandler) {
        this._labelClickHandler(me);
    }
*/
